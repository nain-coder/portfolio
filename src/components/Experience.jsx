  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="relative border-l border-slate-700 ml-4 md:ml-32 space-y-10">
          {experiences.map((item) => (
            <div key={item.id} className="relative pl-6 md:pl-8">
              {/* Timeline Dot */}
              <div className="absolute -left-[9px] top-1.5 w-4 h-4 bg-cyan-400 rounded-full border-4 border-slate-900 shadow-md"></div>
